  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-purple-50 to-white pb-16">
      ...
      <div className="bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 h-44 relative">
        ...
        <Link
          to="/settings"
          className="absolute top-4 right-4 flex items-center gap-2 bg-white/20 hover:bg-white/30 backdrop-blur text-white text-sm font-semibold px-4 py-2 rounded-xl transition-all border border-white/30"
        >
